 ...
 *	\version    $Id: eldy_frontoffice.php,v 1.124 2009/11/02 18:07:12 eldy Exp $
 *
	...
	function showmenu()
	{
		...
		if ($mainmenu)
		{
			...
			if ($mainmenu == 'commercial')
			{
				...
				$newmenu->add(DOL_URL_ROOT."/contact/index.php?leftmenu=prospects&amp;type=p", $langs->trans("List"), 1, $user->rights->societe->contact->lire);
