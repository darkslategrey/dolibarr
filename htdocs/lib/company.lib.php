...
function show_contacts($conf,$langs,$db,$object,$backtopage='')
{
    ...
    if ($user->rights->societe->contact->creer)
    {
      ...
      // ADD GREG 
      $buttoncreate  ='<form action="'.DOL_URL_ROOT.'/contact/fiche.php" method="post">';
      $buttoncreate .= '<input type="hidden" name="socid" value="'.$object->id.'" />';
      $buttoncreate .= '<input type="hidden" name="action" value="create" />';
      $buttoncreate .= '<input type="hidden" name="address" value="'.$object->address.'" />';
      $buttoncreate .= '<input type="hidden" name="zipcode" value="'.$object->zip.'" />';
      $buttoncreate .= '<input type="hidden" name="town" value="'.$object->town.'" />';
      $buttoncreate .= '<input type="hidden" name="pays_id" value="'.$object->pays_id.'" />';
      $buttoncreate .= '<input type="hidden" name="departement_id" value="'.$object->departement_id.'" />';
      $buttoncreate .= '<input type="hidden" name="backtopage" value="'.$backtopage.'" />';
      $buttoncreate .= '<input type="submit" value="'.$langs->trans("AddContact").'" />';
      $buttoncreate .= img_picto($langs->trans("AddContact"),'filenew');
      // END ADD GREG
