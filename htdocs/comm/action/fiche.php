...
if ($action == 'create')
{
    ...
    // Full day
    print '<tr><td class="fieldrequired">'.$langs->trans("EventOnFullDay").'</td><td><input type="checkbox" id="fullday" name="fullday" checked="checked"></td></tr>';
    ...
    $doleditor=new DolEditor('note',(GETPOST('note')?GETPOST('note'):$actioncomm->note),'',280,'dolibarr_notes','In',true,true,false,ROWS_7,90);
    $doleditor->Create();
    print '</td></tr>';
